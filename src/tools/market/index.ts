          ...
          content: [
            {
              ...
              text:
                ...
                `Spread: ${
                  bestBid[0] !== "N/A" && bestAsk[0] !== "N/A"
                    ? (parseFloat(bestAsk[0]) - parseFloat(bestBid[0])).toFixed(8)
                    : "N/A"
                }\n\n` +
          ...
          content: [
            {
              type: "text",
              text:
                `Aggregate Trades for ${symbol}\n` +
                `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n` +
                `Total trades: ${result.length}\n` +
                (summary
                  ? `Agg ID range: ${summary.firstAggId} to ${summary.lastAggId}\n` +
