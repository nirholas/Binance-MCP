      ...
      try {
        ...
        return {
          content: [
            {
              type: "text",
              text: `❌ Failed to place OCO order: ${errorMessage}${additionalHelp}`,
            },
          ],
          isError: true,
        };
        ...
        if (!params.orderListId && !params.origClientOrderId) {
          return {
            content: [
              {
                type: "text",
                text: "❌ Either orderListId or origClientOrderId must be provided.",
              },
            ],
            isError: true,
          };
      ...
      try {
        ...
        if (!params.orderListId && !params.listClientOrderId) {
          return {
            content: [
              {
                type: "text",
                text: "❌ Either orderListId or listClientOrderId must be provided.",
              },
            ],
            isError: true,
          };
          ...
          content: [
            {
              type: "text",
              text:
                `✅ OCO Order cancelled successfully!\n\n` +
                `Order List ID: ${response.orderListId}\n` +
                `Symbol: ${response.symbol}\n` +
                `Status: ${response.listStatusType}\n` +
        ...
        return {
          content: [
            {
              type: "text",
              text: `❌ Failed to cancel OCO order: ${errorMessage}${additionalHelp}`,
            },
          ],
          isError: true,
        };
      ...
      try {
        ...
        return {
          content: [
            {
              type: "text",
              text: `❌ Failed to get open OCO orders: ${errorMessage}${additionalHelp}`,
            },
          ],
          isError: true,
        };
      ...
      try {
        ...
        if (params.fromId && (params.startTime || params.endTime)) {
          return {
            content: [
              {
                type: "text",
                text: "❌ fromId cannot be used together with startTime or endTime.",
              },
            ],
            isError: true,
          };
        ...
        return {
          content: [
            {
              type: "text",
              text: `❌ Failed to get OCO order history: ${errorMessage}${additionalHelp}`,
            },
          ],
          isError: true,
        };
