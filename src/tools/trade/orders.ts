      ...
      try {
          ...
          content: [
            {
              type: "text",
              text:
                `✅ Test order validated successfully!\n\n` +
        ...
        return {
          content: [
            {
              type: "text",
              text: `❌ Test order validation failed: ${errorMessage}${additionalHelp}`,
            },
          ],
          isError: true,
        };
      ...
      try {
        ...
        if (!params.cancelOrderId && !params.cancelOrigClientOrderId) {
          return {
            content: [
              {
                type: "text",
                text: "❌ Either cancelOrderId or cancelOrigClientOrderId must be provided.",
              },
            ],
            isError: true,
          };
        ...
        return {
          content: [
            {
              type: "text",
              text: `❌ Failed to cancel and replace order: ${errorMessage}${additionalHelp}`,
            },
          ],
          isError: true,
        };
      ...
      try {
          ...
          content: [
            {
              type: "text",
              text:
                `📋 Open Orders${params.symbol ? ` for ${params.symbol}` : ""}\n` +
        ...
        return {
          content: [
            {
              type: "text",
              text: `❌ Failed to get open orders: ${errorMessage}${additionalHelp}`,
            },
          ],
          isError: true,
        };
      ...
      try {
          ...
          content: [
            {
              type: "text",
              text:
                `📋 Order History for ${params.symbol}\n` +
        ...
        return {
          content: [
            {
              type: "text",
              text: `❌ Failed to get order history: ${errorMessage}${additionalHelp}`,
            },
          ],
          isError: true,
        };
      ...
      try {
          ...
          content: [
            {
              type: "text",
              text:
                `✅ Cancelled ${response.length} orders for ${params.symbol}!\n\n` +
                `Cancelled Orders:\n${cancelledList}\n\n` +
                `Full Response: ${JSON.stringify(response, null, 2)}`,
            },
          ],
        ...
        return {
          content: [
            {
              type: "text",
              text: `❌ Failed to cancel all open orders: ${errorMessage}${additionalHelp}`,
            },
          ],
          isError: true,
        };
