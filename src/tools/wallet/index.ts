...
export function registerWalletTools(server: McpServer) {
    ...
    "binance_us_withdraw_crypto",
    {
      ...
      inputSchema: {
        ...
        network: z
          .string()
          .describe(
            "Withdrawal network, e.g., ERC20, BEP20, BTC. Ensure address type matches network!",
          ),
        ...
        withdrawOrderId: z
          .string()
          .optional()
          .describe("Client ID for the withdrawal (for your reference)"),
        recvWindow: z.number().optional().describe("The value cannot be greater than 60000"),
      },
    },
    ...
    "binance_us_withdraw_fiat",
    {
      ...
      inputSchema: {
        ...
        paymentMethod: z
          .literal("BITGO")
          .default("BITGO")
          .describe("Payment method (default: BITGO)"),
  ...
  server.registerTool(
    "binance_us_withdraw_history",
    {
      description: "Get crypto withdrawal history. Filter by coin, status, or time range.",
      inputSchema: {
        ...
        status: z
          ...
          .optional()
          .describe(
            "Status filter: 0=email sent, 1=canceled, 2=awaiting approval, 3=rejected, 4=processing, 5=failure, 6=completed",
          ),
  ...
  server.registerTool(
    "binance_us_deposit_history",
    {
      description: "Get crypto deposit history. Filter by coin, status, or time range.",
      inputSchema: {
        coin: z.string().optional().describe("Filter by coin symbol"),
        status: z
          .number()
          .optional()
          .describe("Status filter: 0=pending, 1=success, 6=credited but cannot withdraw"),
        startTime: z.number().optional().describe("Start time in ms. Default: 90 days ago"),
        endTime: z.number().optional().describe("End time in ms. Default: now"),
        offset: z.number().optional().describe("Pagination offset. Default: 0"),
        limit: z.number().optional().describe("Number of results. Default: 1000, Max: 1000"),
    ...
    "binance_us_deposit_address",
    {
      ...
      inputSchema: {
        ...
        network: z
          .string()
          .optional()
          .describe("Specific network to get address for, e.g., ERC20, BEP20"),
        recvWindow: z.number().optional().describe("The value cannot be greater than 60000"),
      },
    },
