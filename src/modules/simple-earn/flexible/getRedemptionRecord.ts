 ...
 * @license Apache-2.0
 */
// src/modules/simple-earn/flexible/getRedemptionRecord.ts
...
export function registerSimpleEarnFlexibleRedemptionRecord(server: McpServer) {
  server.registerTool(
      ...
      try {
        ...
        return {
          content: [
            {
              type: "text",
              text: `📜 Flexible Redemption Records\n\n${JSON.stringify(data, null, 2)}`,
            },
          ],
        };
      } catch (error) {
